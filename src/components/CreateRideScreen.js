...
import EdgeRoutesMap from './EdgeRoutesMap';
        ...
        <Box sx={{ mt: 3, p: 2, border: '1px solid #e0e0e0', borderRadius: 2 }}>
          ...
          <Box sx={{ mt: 2 }}>
            ...
            <Box sx={{ mt: 3 }}>
              ...
              {/* Edge Routes Map */}
              {generatedRoute && generatedRoute.edgeRoutes && (
                <Box sx={{ mt: 3 }}>
                  <Typography variant="h6" gutterBottom>
                    Edge Routes Map
                  </Typography>
                  <Typography variant="body2" color="text.secondary" paragraph>
                    Routes generated by sampling random points from the isochrone polygon edges, snapping them to roads, and connecting them with actual driving routes.
                  </Typography>
              ...
              {generatedRoute && generatedRoute.edgeRoutes && (
                <Box sx={{ mt: 3 }}>
                  <Typography variant="h6" gutterBottom>
                    D3 Route Visualization
                  </Typography>
                  <Typography variant="body2" color="text.secondary" paragraph>
                    Interactive D3 visualization of the generated routes with base map styling similar to the isochrone map.
                  </Typography>
                  
                  <D3RouteMap
                    routeData={generatedRoute.edgeRoutes}
                    startLocation={generatedRoute.startLocation}
                    width={800}
                    height={500}
                  />
